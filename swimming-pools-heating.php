      ...
      <div class="row">
         <div class="col wow fadeInUp " data-wow-delay="400ms">
            <div class="projects grid">
               ...
               <div class="project-single grid-item grid-item--width2 cat2 cat4">
                  <div class="project-single-inner">
                     <div class="project-thumb"> <img src="assets/img/swimming-pools-heating/1.jpg" alt=""> </div>
                     <a href="assets/img/swimming-pools-heating/1.jpg" data-fancybox="project" class="external-link popup-project"><i class="flaticon-plus"></i></a>
                  </div>
               </div>
               <div class="project-single grid-item grid-item--width2 cat2 cat4">
                  <div class="project-single-inner">
                     <div class="project-thumb"> <img src="assets/img/swimming-pools-heating/2.jpg" alt=""> </div>
                     <a href="assets/img/swimming-pools-heating/2.jpg" data-fancybox="project" class="external-link popup-project"><i class="flaticon-plus"></i></a>
                  </div>
               </div>
            </div>
         </div>
